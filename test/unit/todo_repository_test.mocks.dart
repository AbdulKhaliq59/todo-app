...
// in todo/test/unit/todo_repository_test.dart.
...
import 'package:todo/data/services/todo_service.dart' as _i3;
import 'package:todo/domain/models/todo_model.dart' as _i5;
...
class MockTodoService extends _i1.Mock implements _i3.TodoService {
  ...
  @override
  _i4.Future<void> insertTodo(_i5.TodoModel? todo) =>
      (super.noSuchMethod(
  ...
  @override
  _i4.Future<List<_i5.TodoModel>> fetchTodos() =>
      (super.noSuchMethod(
  ...
  @override
  _i4.Future<void> updateTodo(_i5.TodoModel? todo) =>
      (super.noSuchMethod(
